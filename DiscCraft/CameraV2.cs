...
namespace DiscCraft
{
    public class CameraV2
    {
        ...
        /// </summary>
        public CameraV2(GraphicsDevice gfxDevice, GameWindow window)
        {
        ...
        {
            Position += (camerasWorld.Forward * MovementUnitsPerSecond / 5) * (float)gameTime.ElapsedGameTime.TotalSeconds;
        }
        public void MoveBackward(GameTime gameTime)
        {
            Position += (camerasWorld.Backward * MovementUnitsPerSecond / 5) * (float)gameTime.ElapsedGameTime.TotalSeconds;
        }
        public void MoveLeft(GameTime gameTime)
        {
            Position += (camerasWorld.Left * MovementUnitsPerSecond / 5) * (float)gameTime.ElapsedGameTime.TotalSeconds;
        }
        public void MoveRight(GameTime gameTime)
        {
            Position += (camerasWorld.Right * MovementUnitsPerSecond / 5) * (float)gameTime.ElapsedGameTime.TotalSeconds;
        }
