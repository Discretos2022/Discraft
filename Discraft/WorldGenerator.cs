...
namespace Discraft
{
    public class WorldGenerator
    {
        ...
        public static string SEED = "101092939475637";
        private static PerlinNoise n = new PerlinNoise();


        public static int GetBlockID(Vector3 worldPosition)
        {
